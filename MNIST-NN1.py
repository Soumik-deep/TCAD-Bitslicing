...
fp1=open('NNDense_memory_profiler.log','a+')     
@profile(stream=fp1)
def denseLayer(layer,input,weight_matrix,bias):
  ...
  print("wgt matrix="+str(weight_matrix))
  print("Weight matrix[0"+str(weight_matrix[0]))
  ...
  print("the Sieze of the ouput is"+str(len(layer_output)))
